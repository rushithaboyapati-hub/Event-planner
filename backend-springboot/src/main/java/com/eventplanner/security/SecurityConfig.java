    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/uinfo").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/events/**", "/api/categories/**", "/api/venues/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/events/calendar").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/users/*/registrations").hasAnyRole("USER", "ORGANIZER", "ADMIN")
                .requestMatchers("/api/users/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/events/*/register").hasAnyRole("USER", "ORGANIZER", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/events/*/register").hasAnyRole("USER", "ORGANIZER", "ADMIN")
                ...
                .requestMatchers("/api/categories/**").hasAnyRole("ORGANIZER", "ADMIN")
